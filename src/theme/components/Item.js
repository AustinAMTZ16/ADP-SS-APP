...
export default (variables = variable) => {
    ...
    "NativeBase.Input": {
      ...
      fontSize: variables.inputFontSize,
      lineHeight: 16,//variables.inputLineHeight
    },
    ".underline": {
      "NativeBase.Input": {
        paddingLeft: 15
      ...
      borderWidth: Platform.OS === "ios" ? 1.5 : 0.7,
      borderTopWidth: 0,
      borderRightWidth: 0,
      borderLeftWidth: 0,
    ...
    borderWidth: variables.platform === 'ios' ? variables.borderWidth : variables.borderWidth * 3,
    borderTopWidth: 0,
    borderRightWidth: 0,
    borderLeftWidth: 0,
    borderColor: variables.inputBorderColor,
