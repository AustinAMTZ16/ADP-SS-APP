...
export default (variables = variable) => {
  ...
  const buttonTheme = {
    ...
    ".secundary": {
      backgroundColor: variables.btnSecundaryColor,
      "NativeBase.Text": {
    ...
    ".roundedCircle": {
      borderRadius: variables.borderRadiusBold
    },
    ...
    ".wide": {
      paddingHorizontal: variables.buttonPadding + 45,
      "NativeBase.Text": {
        fontSize: 16
      }
    },
    ...
    ".buttonFooterTabActive": {
      borderColor: '#A2ACB3', borderTopWidth: 2, borderRadius: 0
    },
    ".buttonFooterTab": {
      borderColor: 'transparent', borderTopWidth: 2, borderRadius: 0
    },
